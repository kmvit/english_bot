...
HELP_TEXT = (
    ...
    "<b>Непонятное слово</b> — выдели его прямо в моём сообщении и нажми "
    "«Ответить». Разберу, покажу пример и положу в словарь; потом спрошу "
    "его на тренировке. Можно к выделенному дописать свой вопрос.\n\n"
